...
window[CHANNEL.name].sequenceList = {
	'layout':      { active: 1, rank: -1, url: "//rawgit.com/shcglv/CyberTavern/master/Custom.js",              callback: true },
    'channel':      { active: 1, rank: -1, url: "//rawgit.com/shcglv/CyberTavern/master/enhanced.js",              callback: true },
    'Xaekai Modules':      { active: 1, rank: -1, url: "//rawgit.com/shcglv/CyberTavern/master/XaekaiModules.js",              callback: true },
};
...
$('head').append("<link rel='stylesheet' href='//rawgit.com/shcglv/CyberTavern/master/base.css' />");
$('head').append("<link rel='stylesheet' href='//rawgit.com/shcglv/CyberTavern/master/theme.css' />");
$(".navbar-brand").text("CyberTavern");
